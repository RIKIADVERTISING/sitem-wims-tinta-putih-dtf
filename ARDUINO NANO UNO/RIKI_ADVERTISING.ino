...
lcd.setCursor(0,0);
if(flag3==0){lcd.print("OFF ");}
if(flag3==1){lcd.print("ON ");}
lcd.print("WIMS");
if(set==0 && mode>0){lcd.print(" SETING ");}
if(set==0 && mode==0 && flag2==0){lcd.print("  STOP ");}
if(set==0 && mode==0 && flag2==1){lcd.print(" START ");}
if(set==1){lcd.print(" SET D  ");}
if(set==2){lcd.print(" SET M  ");}
if(set==3){lcd.print(" SET J  ");}
